        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                "For allocation intents (budget + constraints), prefer canix_get_plan (POST /plans) over assembling quotes yourself. The plan reuses eligibility and returns ordered unsigned groups (quotes[] / order / prerequisiteShapeKeys), including live Haystack opt-in → swap → enter compose when requiredAssetIds differ from the budget asset. For a single “I hold A, I want this opportunity” path, use canix_compose_enter (POST /execution/compose). Groups stay unmerged. Sign only user legs; preserve Haystack pre-signed members. Sign and submit locally — do not fork a compiler.",
